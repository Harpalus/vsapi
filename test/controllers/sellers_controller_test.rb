...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { latitude: @seller.latitude, longitude: @seller.longitude, name: @seller.name } }, as: :json
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { latitude: @seller.latitude, longitude: @seller.longitude, name: @seller.name } }, as: :json
    assert_response 200
  end
